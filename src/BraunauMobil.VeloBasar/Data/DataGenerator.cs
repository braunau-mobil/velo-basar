...
namespace BraunauMobil.VeloBasar.Data
{
    public class DataGenerator
    {
        ...
        private static readonly string[] _productType = new string[] { "Einrad", "Rennrad", "City-Bike Herren", "City-Bike Frauen", "Kinderrad", "Roller", "E-Bike", "Stahlross" };
        ...
        private static readonly string[] _countryCodes = new string[] { "AUT", "GER" };
        ...
        public async Task GenerateAsync()
        {
            ...
            {
                await CreateBasarAsync(_config.FirstBasarDate.AddYears(basarNumber - 1), $"{basarNumber}. Fahrradbasar");
            }
        }
        ...
        {
            seller.CountryCode = _countryCodes.TakeRandom(_rand);
        ...
        {
            return _productType.TakeRandom(_rand);
        }
    }
}
