...
public class GetPayoutCommissionAmount
{
    [Theory]
    [VeloAutoData]
    public void Empty_ShouldReturnZero(TransactionEntity sut)
    {
        ...
        //  Act
        decimal result = sut.GetPayoutCommissionAmount();
    ...
    [Theory]
    [VeloAutoData]
    public void ShouldReturnOnlyCommisionPartOfAllPayoutProducts(TransactionEntity sut, ProductEntity soldProduct, ProductEntity lostProduct)
    {
        //  Arrange
        ...
        //  Assert  
        result.Should().Be((soldProduct.Price + lostProduct.Price) * sut.Basar.ProductCommission);
    }
}
