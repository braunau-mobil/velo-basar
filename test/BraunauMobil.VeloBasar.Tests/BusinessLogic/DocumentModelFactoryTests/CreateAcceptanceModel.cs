    ...
    : TestBase
{
    ...
    [InlineData("StatusLinkFormat_{0}", "StatusLinkFormat_X123", true)]
    public void NoStatusLink(string? statusLinkgFormat, string expectedStatusLink, bool expectedAddTokenAndStatusLink)
    {
        //  Arrange
        Settings.Acceptance.SignatureText = "SignatureText";
        Settings.Acceptance.StatusLinkFormat = statusLinkgFormat;
